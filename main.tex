...
\begin{document}
    ...
    \glqq Das objektiv Sittliche das an die Stelle des Abstrakten Guten tritt, ist durch die Subjektivität [...] konkrete Substanz.\grqq{} (S.161)\fullcite{BuchHegel} \\
    Und:\\
    \glqq Andererseits sind sie [die Gesetze des des objektiv Sittlichen] dem Subjekte nicht ein Fremdes, sondern es gibt das Zeugnis des Geistes von ihnen als von seinem eigenen Wesen.\grqq{} (S. 162)\fullcite{BuchHegel} \todo{Welches Buch? Einf\"ugen als echtes Zitat}
    ...
    Der Ausgang \glqq Tür auf den Gang\grqq{} wird zwar angezeigt, aber bei dem Versuchen diesen Auszuwählen, erfolgt die Ausgabe: \textit{Diese Tür ist verschlossen, finde den passenden Schlüssel in dir, um sie zu öffnen}.
