...
\begin{document}
    ...
    \section{Traum Raum}
    Neben dem Hauptgeschehen, sollen in einzelnen Bereichen nebenstrenge aufgemacht, oder zusätzliche Erfahrungen gemacht werden können. 
    Neben dem \hyperref[textadventure]{Textadventure} ist der sog. \glqq Traum Raum\grqq{} eines dieser Orte.
    Hier soll den Spieler*innen verschiedene Träume vorgeführt werden. 
    Bzw. es wird ihnen ein Traum gezeigt, auf den sie selbst Einfluss nehmen können. 
    Dies soll mit einer einfachen Texteingabe (bezaubernd wäre natürlich durch Spracheingabe) geschehen. 
    Den Teilnehmer*innen werden Fragen gestellt und die \glqq Künstliche Intteligenz\grqq{} reagiert auf bestimmte Stichwörter und führt je nach Wort den Traum auf andere Art und Weise fort.
    Zugleich werden die einzelnen Traumsequenzen bestimmten Kategorien zugeordnet, die sich mit den \glqq Minds\grqq{} im 
    Der Traum selbst wird in form 
    ...
    \glqq Sie erscheint außerdem als die \textit{wahrhafteste}; denn sie hat von dem Gegestande noch nicht weggelassen, sondern ihn in seiner Vollständigkeit vor sich.\grqq\cite{hegel:pdg}
    ...
    \glqq Sie sagt von dem was sie weiß, nur dies aus: es \textit{ist} und ihrer Wahrheit enthält allein das \textit{Sein} der Sache\grqq\cite{hegel:pdg}.
    ...
    Die Kunst \glqq errette[t] [...] neutralisiert, was einmal die Menschen buchstäblich und ungeschieden am Dasein erfuhren und was aus diesem der Geist vertrieb\grqq.\cite{adorno:at}
