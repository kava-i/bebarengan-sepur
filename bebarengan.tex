...
\begin{itemize}
  \item Traum (Traum, in einer \qq{Traum-Maschine}) [mechat (russ. Traum), Illyziya (russ. Illusion), videniye (russ. Vision), ngimpi (jav. Traum), khayalan (jav. Illusion)]
...
Zunächst war noch Katja E. eine Art Führerin dieses Kollektives doch bald schon entwickelte sich ein erweiterter Kreis, vielleicht etwas wie ein \qq{Vorstand}, der koordinatorische Aufgaben übernahm, aber auch gewisse Zielsetzungen formulierte.\\
...
\begin{itemize}
  ...
  \item die Öffner (Plädieren für Öffnung des Kollektives und eintreten in offenen Kampf mit der Regierung für die legal Nutzung der Traum-Maschinen in der breiten Bevölkerung - zugleich sind die recht bürgerlich und verbinden keine \qq{höheren Ziele} mit dem Träumen)
