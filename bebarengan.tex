...
Das Liverollenspiel durchläuft vier Akte und diese auf zwei unterschiedlich gewichteten
Ebenen, die jeweils wieder mehrere Ebenen enthalten.
Die erste, bedeutendere Ebene ist das Spiel selbst, die zweite ein in das Spiel
integriertes virtuelles Spiel, das \emph{Textadventure}, welches eng mit der ersten Ebene
verknüpft, diese stets wieder aufgreift, verändert und selbst durch sie verändert wird. 
Die erste Ebene - das Spiel selbst - unterteilt sich nochmals in die folgenden Ebenen:
1. die echte Realität (R-Ebene) 2. Spielrealität (SR-Ebene) 3. Abstraktion oder Spielmechanismen, die
nur auf einer Metaebene/ der P-Ebene Bedeutung haben (A-Ebene) und 4. die philosophische
Ebene (P-Ebene). 
(Die innere Aufteilung der zweiten Ebene wird in dem entsprechenden Abschnitt zum
\hyperref[textadventure]{\emph{Textadventure}} aufgeschlüsselt.) 

Neben dem Aufteilen in verschiedene Ebenen, teilt sich das Spiel zugleich in zwei
Szenarien, die nacheinander bespielt werden:
\begin{enumerate}
  \item Spieltag: die Charaktere befinden sich auf einer Zugfahrt.
  \item Spieltag: die Charaktere befinden sich in einem Krankenhaus.
\end{enumerate}
Auf die Eigenheiten dieser Teile wird später näher eingegangen. 
Dies sei nur hier schon erwähnt, da sie eine Einwirkung auf die Akte haben. 
So ist beispielsweise Akt I hauptsächlich im 1. Teil präsent (es ist noch zu diskutieren, ob er sich in Teil 2 überhaupt wiederholt) und Akt IV spielt nur im 2. Teil. 
Die andere Akte (II, III) wiederholen sich in beiden Teilen.\

\emph{Anmerkungen zu Begrifflichkeiten: von \qq{Spieler*innen} ist nur die Rede, wenn die
  Real existierende Person gemeint ist, dagegen meint \qq{Charakter} stets den
  dargestellten Charakter, heißt: eine fiktive Person.
  Demnach existieren auf der R-Ebene nur \qq{Spieler*innen}, auf der SR-Ebene hingegen nur
\qq{Charaktere}. Auf M- und P-Ebene kann beides gemeint sein.}

\subsection{Akt I-Der Raum}
\begin{itemize}
\item[R] Jede*r ist alleine in einem Raum in der Basa
\item[SR] ein Zugabteil 
\item[A] das Unterbewusste der Einzelnen
...
\begin{itemize}
\item[R] Die Tür des Raumes der Spieler*innen ist nun geöffnet, sie können den Gang betreten und treffen mit den anderen Spieler*innen ihrer Etage zusammen.
Das Spiel kann nun auf der ganzen Etage stattfinden. 
Die Tür zur oberen, bzw. unteren Etage ist immer noch verschlossen.
\item[SR] Auf der Ebene der Spielrealität können sich die Charaktere nun frei in ihrem Waggon bewegen. 
  Sie können die anderen Menschen im Zug treffen, mit ihnen reden und sich austauschen. 
  Dabei geraten sie zunächst mit anderen Charakteren in Konflikt (jeder Charakter sollte
  idealerweise einen solchen Konflikt \qq{vorprogrammiert} haben). 
  Durch diese Konflikte, bzw.~den durch sie angestoßenen Prozess finden sich die Menschen in
  Kollektive zusammen.
  Am Ende des Zugabteils/ Krankenhausganges findet sich eine Tür mit der Aufschrift \qq{Tür defekt}.
  Diese Tür wird sich erst in Akt III öffnen.
  \item[P] Auf der philosophischen Ebene treten die Charaktere aus dem bloß subjektiven
  Standpunkt ihrer persönlichen Moral heraus und gelangen in den Konflikt zu anderen
  Selbstbewusstseinen (Herr-Knecht-Dialektik). 
  In diesen Konflikten, werden die Charaktere zu \emph{Handelnden} und durch diese
  Konstituiert sich eine gemeinsame Praxis von Handelnden, eine objektive Welt: Sittlichkeit.
  Das Gesetz der Objektivität, ihres Kollektives, tritt ihnen gegenüber, bzw.~tritt zunächst
  mit ihnen zusammen:
  Sie können sich in ihm selbst erkennen und bilden an ihm ihr Wesen. 
  Die Sittlichkeit und (zweite Natur) der Kollektive bildet sich heraus.
  Das objektive Gesetz tritt den Charakteren aber noch nicht \emph{entgegen}, das Gefühl der
  Naturverkehrtheit wirkt authentisch und die Individuen geraten noch nicht mit ihm in
  Konflikt, es treten noch keine Widersprüche auf. 
...
\begin{itemize}
  ...
  \item[SR] Die Zugwägen/Krankenhausebenen vereinen sich und die Charaktere treffen mit den
  Charakteren/Kollektiven des jeweils anderen Teils aufeinander.

  Im Fall des ersten Teils ist diese \qq{Zusammenführung} begründet durch ein nahendes Zugunglück,
  durch welches die Türen geöffnet werden müssen.
  Dadurch ist die Öffnung auf eine Stunde beschränkt, danach findet das Zugunglück statt
  und der erste Teil beendet.
  Bei der zweiten Vereinigung (Teil 2) ist die Öffnung permanent und die Spieler haben die Zeit ihre Rolle in den Kollektiven als auch die Rolle des Kollektivs in der vereinten Welt zu ergründen.
  \item[A] Beim Vereinen der Züge beschränkt ein Countdown das Vermischen der Gruppe auf eine
  endliche Zeit, vllt.~1 Stunde \hyperref[die-öffnung]{(Die Öffnung)}. 
  \item[P] Infragestellung, der 2. Natur durch die Begegnung mit anderen Kollektiven.
  Durch diese Zusammenführung hervorgerufene Hinterfragung von Sittlichkeit,
  Rechtsverständnis und zweiter Natur im allgemeinen, stellt sich ein Bewusstsein der
  Naturverkehrtheit ein. 
\end{itemize}
...
\begin{itemize}
  ...
  \item Pete, beste Freundin von Alex, und hilft Alex, dabei Kollektiv zusammen
    ...
    in der Charakterbeschreibung das Ziel findet: \qq{Sammelt Menschen um euch,
    die leicht davon überzeugt werden können, dass sie sich in einem Traum
    befinden.}
\end{itemize}
...
Dass wir letztendlich einen Schein erschaffen müssen, der \qq{so weit in seiner
Selbstverspottung geht, mich fühlen zu lassen, dass hier Schein und Irrlich und
Geistertanz und nichts Mehr ist}\footcite[][417]{nietzsche_morgenrote_1999}.\\
...
\begin{itemize}
  \item Traum (Traum, in einer \qq{Traum-Maschine}) [mechat (russ. Traum),
    Illyziya (russ. Illusion), videniye (russ. Vision), ngimpi (jav. Traum),
    khayalan (jav. Illusion), somnum (lat. Schlaf)]
  \item träumen (träumen in einer \qq{Traum-Maschine}) [siehe oben]
  \item träumen, slang (träumen in einer \qq{Traum-Maschine}, meistens auf Grund von Suchtbefriedigung) \underline{ngimpi} (jav. Traum)
  ...
  \item Techniker (Informatiker und Techniker, die an den Traummaschinen forschen, sie weiterentwickeln und programmieren) \underline{teknis} (von \qq{teknisi}, jav. Techniker).
...
\todo[noline]{Wie kriegen wir es hin, dass das nicht eins zu eins \qq{Inzeption} ist?}
...
Zunächst war noch Katja E. eine Art Führerin dieser Untergrundszene doch bald schon entwickelte sich ein erweiterter Kreis, vielleicht etwas wie ein \qq{Vorstand}, der koordinatorische Aufgaben übernahm, aber auch gewisse Zielsetzungen formulierte.\\
...
\begin{itemize}
  ...
  \item die Öffner (plädieren für Öffnung des Untergrundes und Eintreten in
    ...
    \qq{höheren Ziele} mit dem Träumen)
...
Andere Fraktionen (abgesehen von den >>Schließern<< [und den >>Radikalen<<]\todo{nicht sicher was die Radikalen angeht}) sympatisieren zwar teilweise mit einer Öffnung bzw. Legalisierung, kritisieren jedoch die rein wirtschaftliche und (national) ökonomisch orientierte Argumentationsweise.
...
(So muss, den \qq{überkritischen}, Linken zu Gute gehalten werden, dass hier nicht der beliebte Fehler begannen wird >>alles was hinkt, für einen Vergleich zu nehmen<< und durchaus sich einer Sache genauer zu überlassen, bevor sie >>meine Sache<< genannt wird.)
